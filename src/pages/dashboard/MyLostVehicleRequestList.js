...
import {
  ...
  MyLostVehicleRequestTableRow,
} from '../../sections/@dashboard/my-lost-vehicles/list';
// ----------------------------------------------------------------------
import {
...
export default function MyLostVehicleRequestList() {
  const {
    dense,
    //
    selected,
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.myLostVehicles.edit(paramCase(id)));
  };
  ...
  return (
    <Page title="My Lost Vehicles: List">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading="My Lost Vehicles List"
          links={[
            { name: 'Dashboard', href: PATH_DASHBOARD.root },
            { name: 'My Lost Vehicles', href: PATH_DASHBOARD.myLostVehicles.root },
            { name: 'List' },
          ]}
          action={
            <Button
              ...
              to={PATH_DASHBOARD.myLostVehicles.new}
        ...
        <Card>
          ...
          <MyLostVehicleRequestTableToolbar filterName={keyword} onFilterName={handleSearch} />
